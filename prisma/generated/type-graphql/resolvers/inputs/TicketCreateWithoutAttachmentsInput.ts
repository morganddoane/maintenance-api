...
import { UserCreateOneWithoutTicketInput } from "../inputs/UserCreateOneWithoutTicketInput";
import { TicketState } from "../../enums/TicketState";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class TicketCreateWithoutAttachmentsInput {
  ...
  @TypeGraphQL.Field(_type => UserCreateOneWithoutTicketInput, {
    nullable: false
  })
  createdBy!: UserCreateOneWithoutTicketInput;
